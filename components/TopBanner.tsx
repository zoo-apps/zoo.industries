...
export default function TopBanner() {
  return (
    <div className="fixed top-0 left-0 right-0 z-[60] bg-[#1faa59] text-black border-b-2 border-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-center gap-3 text-center text-sm font-semibold">
        ...
        <span className="truncate">Zen4 MoDE models now available for enterprise deployment</span>
        <Link
          href="/research"
